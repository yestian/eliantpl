    ...
    render() {
        ...
        return (
            <div className="tabs">
                ...
                <div className={`tab settings-tab ${data===2?'active':''}`} data-automation-id="right-sidebar-settings-tab-link" onClick={(e)=>fn.onClick(e,2)}
                onMouseEnter={(e)=>fn.onMouseEnter(e)}
                onMouseLeave={(e)=>fn.onMouseLeave(e)}>
                    <span className="sprite-mid"><i></i></span>
                </div>
                <div className={`tab navigator-tab ${data===3?'active':''}`} data-automation-id="right-sidebar-navigator-tab-link" onClick={(e)=>fn.onClick(e,3)}
                onMouseEnter={(e)=>fn.onMouseEnter(e)}
                onMouseLeave={(e)=>fn.onMouseLeave(e)}>
                    <span className="sprite-mid"><i></i></span>
                </div>
