...
class Padding extends Component{
    render(){
        ...
        let {showNodePadding}=this.props;
        return(
            <div className="padding">
                ...
                <div className="handle sprite-mid top reverse" title="修改上填充" style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}
                    ...
                    onMouseLeave={()=>{showNodePadding(0)}}><svg width={16} height={9} viewBox="0 0 16 9" className="bem-Svg " style={{display: 'block', transform: 'translate(0px, 0px)'}}><path d="M3 3h10v1H3zM1 1h14v1H1zm4 4h6v1H5zm2 2h2v1H7z" fill="currentColor" /></svg></div>
