                ...
                <div className="guidance-panel-wrapper">
                    <div className="guidance-panel-child">
                        <div className="kit-field kit-field clear">
                            <div className="label kit-label " title="Clear"><div className="link"><i /><span>清除浮动<span className="colon">:</span></span></div></div>
                            <div className="kit-radio-buttons kit-input-control clearfix">
                                <div className="kit-button kit-radio-button active none" label="None"><svg width={11} height={11} viewBox="0 0 11 11" className="bem-Svg " style={{display: 'block', transform: 'translate(0px, 0px)'}}><path fill="none" stroke="currentColor" stroke-miterlimit={10} d="M2 9l7-7M2 2l7 7" /></svg><span>无</span></div>
