...
class Width extends Component{
    ...
    openProp(e,states){
        ...
        this.props.data.openPropWindow(e,'width')
    }
                ...
                <div className="guidance-panel-wrapper">
                    <div className="guidance-panel-child">
                        <div className="kit-field">
                            <div className="label kit-label " title="Width" onClick={(e)=>{this.openProp(e,res.a)}}>
                            ...
                            <div className="kit-unit-box kit-text-input">
                                ...
                                <span className="unit" onClick={()=>{data.openUnit(1)}}>{unit}</span>

                                {data.right.layout.openUnit===1?<Unit onClick={this.formTranslate} unit={unit}/>:''}
