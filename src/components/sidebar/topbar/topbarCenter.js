...
class TopbarCenter extends Component{
    render(){
        ...
        let selectedId=this.props.index.selectedId;
        return(
            <div className="bem-TopBar_Body_Group">
                <div className={`bem-TopBar_Body_Button bem-TopBar_Body_MediaQueryButton ${media===1?'bem-TopBar_Body_MediaQueryButton-active':''}`} data-automation-id="media-pc" onClick={(e)=>this.props.onClick(e,1,selectedId)}
                ...
                <div className={`bem-TopBar_Body_Button bem-TopBar_Body_MediaQueryButton ${media===2?'bem-TopBar_Body_MediaQueryButton-active':''}`} data-automation-id="media-tablet" onClick={(e)=>this.props.onClick(e,2,selectedId)}
                onMouseEnter={(e)=>this.props.onMouseEnter(e)}
                onMouseLeave={(e)=>this.props.onMouseLeave(e)}>
                ...
                <div className={`bem-TopBar_Body_Button bem-TopBar_Body_MediaQueryButton ${media===3?'bem-TopBar_Body_MediaQueryButton-active':''}`} data-automation-id="media-landscape" onClick={(e)=>this.props.onClick(e,3,selectedId)}
                onMouseEnter={(e)=>this.props.onMouseEnter(e)}
                onMouseLeave={(e)=>this.props.onMouseLeave(e)}>
                ...
                <div className={`bem-TopBar_Body_Button bem-TopBar_Body_MediaQueryButton ${media===4?'bem-TopBar_Body_MediaQueryButton-active':''}`} data-automation-id="media-portrait" onClick={(e)=>this.props.onClick(e,4,selectedId)}
                onMouseEnter={(e)=>this.props.onMouseEnter(e)}
                onMouseLeave={(e)=>this.props.onMouseLeave(e)}>
