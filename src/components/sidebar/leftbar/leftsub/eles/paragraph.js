...
class Paragraph extends Component{
    ...
    render(){
       ...
       //-------------------------------------------
       let title='段落';
       let svg=<svg width={59} height={16} viewBox="0 0 59 16" className="bem-Svg " style={{display: 'block', transform: 'translate(0px, 0px)'}}><path opacity=".4" d="M0 0v16h29v-4h29V8h-1V4h2V0H0zm1 7h55H1zm57-4H1h57z" /><path fill="currentColor" d="M1 1v2h57V1H1zm55 4H1v2h55V5zM1 11h56V9H1v2zm0 4h27v-2H1v2z" /></svg>;
        //--------------------------------------------
