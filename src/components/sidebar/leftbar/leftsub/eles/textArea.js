...
class TextArea extends Component{
    ...
    render(){
       ...
       //-------------------------------------------
       let title='多行文本';
       let svg=<svg width={50} height={32} viewBox="0 0 50 32" className="bem-Svg " style={{display: 'block', transform: 'translate(0px, 0px)'}}><path fill="currentColor" d="M47 3v26H3V3h44m2-2H1v30h48V1z" /><path opacity=".2" fill="currentColor" d="M3 3h44v26H3z" /><path opacity=".4" d="M49 1v30H1V1h48m1-1H0v32h50V0z" /><path opacity=".5" fill="currentColor" d="M7 6h2v9H7zm29.3 20h1.4l6.3-6.3v-1.4L36.3 26zm4.4 0l3.3-3.3v-1.4L39.3 26h1.4zm3 0l.3-.3v-1.4L42.3 26h1.4z" /></svg>;
         //--------------------------------------------
